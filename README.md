...
欢迎来到**工韵**的 GitHub 开源页面, 这是一款基于超星教务系统（**湖北工业大学**定制）的第三方教务管理系统，运行于 **Android** 平台，支持的最低版本为 **Android 8.0 (API level 26)**
...
如果您的学校使用的教务系统为超星（教务系统地址形如**hbut.jw.chaoxing.com**），那么此开源项目或许将对您有所帮助。
